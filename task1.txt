ID: TC_001
Название: Успешная оплата банковской картой. Позитивный
Предусловия:
...
ID: TC_002
Название: Оплата картой отклонена банком. Негативный
Предусловия:
  - Существует заказ в статусе "Ожидает оплаты"
  - Открыта страница веб-приложения по оплате
...
ID: TC_003
Название: Ошибка платежного сервиса при оплате. Негативный
Предусловия:
...
ID: TC_004
Название: Клиентская валидация пустых полей. Негативный
Предусловия:
  - Открыта страница веб-приложения по оплате
...
ID: TC_005
Название: Клиентская валидация некорректный CVC. Негативный
Предусловия:
  - Открыта страница веб-приложения по оплате
  - Открыт DevTools на вкладке Network
Шаги:
...
ID: TC_007
Название: Отправка данных в платежный шлюз. Позитивный
Предусловия:
  - Существует заказ в статусе "Ожидает оплаты"
  - Открыта страница веб-приложения по оплате
  - Открыт DevTools на вкладке Network
